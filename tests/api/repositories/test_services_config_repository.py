...
class TestServicesConfigRepository(unittest.TestCase):
    ...
    def test_initialization_bad_yaml_file(self):
        self.assertRaises(ServicesConfigException, ServicesConfigRepository.load_services_config, svc_file="./tests/resources/bad_yaml.yaml")
    ...
    def test_initialization_bad_shema_file(self):
        self.assertRaises(ServicesConfigException, ServicesConfigRepository.load_services_config, svc_file="./tests/resources/services_bad_schema.yaml")
