...
def client_config_repo_mock():
    ...
    client_config_repo_mock.get_client.side_effect = lambda client_id: data.get(client_id, None)
    return client_config_repo_mock

def test_is_valid_client_id_with_secret(client_config_repo_mock):
...
def test_get_client_authorization_for_service(client_config_repo_mock):
    service_service = ClientService(client_config_repo_mock)
