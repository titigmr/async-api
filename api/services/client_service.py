...
from api.repositories.client_config_repository import (
    ClientAuthorization,
    ClientConfig,
...
class ClientService:
    ...
    def __init__(
        self,
        client_config_repository: Annotated[
            ClientConfigRepository, Depends(ClientConfigRepository)
        ],
    ) -> None:
    ...
    def is_valid_client_id(self, client_id: str, client_secret: str | None) -> bool:
        ...
        """
        client_config: ClientConfig | None = self.client_config_repository.get_client(
            client_id=client_id
        )
    ...
    def get_client_authorization_for_service(
        self, client_id: str, service: str
        ...
        authorization: ClientAuthorization | None = client_config.authorizations.get(
            service
        )
        if authorization is not None:
            return authorization
